						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12 text-center">
									<img src="{{ asset('assets/gif/laundry-cat.gif') }}" class="proses-gif">
									<img src="{{ asset('assets/gif/selesai.gif') }}" class="selesai-gif" hidden="">
									<img src="{{ asset('assets/gif/scooter-running.gif') }}" class="diantar-gif" hidden="">
									<img src="{{ asset('assets/gif/completed.gif') }}" class="diambil-gif" hidden="">
								</div>
								<div class="col-md-12">
