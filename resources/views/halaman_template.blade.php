...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/icons/pratama_icon.png') }}">
            ...
            <div class="brand-logo">
                <a href="{{ url('/dashboard') }}">
                    ...
                    <span class="brand-title">
                        <img src="{{ asset('assets/icons/pratama_text.png') }}" width="110" alt="">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                <img src="{{ asset('assets/pictures/' . auth()->user()->avatar ) }}" height="40" width="40" alt="">
                            </div>
