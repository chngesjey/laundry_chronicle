						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12 text-center">
									...
									<img src="{{ asset('assets/gif/selesai.gif') }}" class="selesai-gif">
									@elseif($transaksis->status == 'diantar')
									<img src="{{ asset('assets/gif/scooter-running.gif') }}" class="diantar-gif">
									@elseif($transaksis->status == 'diambil')
									<img src="{{ asset('assets/gif/completed.gif') }}" class="diambil-gif">
									@endif
								</div>
								<div class="col-md-12">
									@if($transaksis->status == 'proses')
