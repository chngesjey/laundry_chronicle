            ...
            <div class="card" style="background-color: #dcdbfd;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('assets/images/laundry.png') }}" class="laundry-gambar">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <form method="POST" class="form_edit_identitas" enctype="multipart/form-data">
                                ...
                                <div class="text-center">
                                    <div class="foto">
                                        <img src="{{ asset('assets/pictures/' . auth()->user()->avatar) }}" class="profil-pict rounded-circle img-thumbnail">
